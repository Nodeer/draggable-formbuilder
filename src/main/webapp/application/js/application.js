define([
    ...
    Application.on("start", function() {
        if ( Backbone.history ) {
            require([
                "bootstrap",
                "application/modules/radio/radio.app",
                "application/modules/forms/forms.app",
                "application/modules/editor/editor.app",
                "application/modules/button/button.app",
                "application/modules/sidebar/sidebar.app",
                "application/modules/toolbox/toolbox.app",
                "application/modules/textarea/textarea.app",
                "application/modules/checkbox/checkbox.app",
                "application/modules/textfield/textfield.app"
                ], function() {
